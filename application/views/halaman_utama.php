...
<body class="page-locked layout-full">
  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      ...
      <p class="locked-user">SIJUBEL</p>
      <p>Masuk ke halaman akun sebagai <a href="<?php echo base_url(); ?>login/login_pegawai">Pegawai</a></p>
      <p>Atau masuk sebagai <a href="<?php echo base_url(); ?>login/login_pemilik">Pemilik</a></p>
